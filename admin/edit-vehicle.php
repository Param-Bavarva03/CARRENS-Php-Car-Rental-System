...
<label class="col-sm-2 control-label">Avability<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="stock" class="form-control" value="<?php echo htmlentities($result->stock);?>" required>
</div>
