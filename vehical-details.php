      ...
      <!--Side-Bar-->
       ...
       <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <a href="t&c.php?type=terms"><input type="radio" name="tc" required="required">Terms and Conditions</a>
            </div>	
        ...
        $results=$query2->fetchAll(PDO::FETCH_OBJ);
				if($lastInsertId)
				{
				  if ($result->stock>0) {
            $dateob= date("d:m:Y,D");
            $ppd=htmlentities($result->PricePerDay);
						$abc = $result->stock;
						  $abc=$abc-1;
						  $_SESSION["stock"] = $abc;
              ...
              $mpdf = new \Mpdf\Mpdf();
              $data = '<img src="assets/images/RENTSCAR.png">';
              $data .= '<hr>';
              $data .= '<centre><h1>BILL OF BOOKING/centre>';
              $data .= '<table border="1">
              <tr>
                <th>Full Name</th>
                <td> '.$fname.'</td>
              ...
              $data .= '<hr>';
              $data .= '<p>For any query contact us</p>';
              $data .= '<p>Email Address :<a href="mailto:modiy2433@gmail.com" >modiy2433@gmail.com</a> </p>';
              $data .= '<p>Call Us : <a href="tel:91-1234-5678-09">+918160632794</a></p>';
              $mpdf->writeHTML($data);
              ...
              require './PHPMailerAutoload.php';
                  ...
                  $mail->Body    = "Hello! user here is your bill of booking have a safe journey :)";
